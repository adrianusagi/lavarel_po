...
<table class="table mt-5">
    ...
    <tfoot>
        <tr>
            ...
            <th data-idx="sub_total"><?php echo number_to_currency($raw->sub_total) ?></th>
        </tr>
        <tr>
            <th colspan="4" class="text-right">
                VAT / TAX <?php echo $raw->vat_percent ?>%
            </th>
            <th data-idx="vat"><?php echo number_to_currency($raw->vat);?></th>
        </tr>
        <tr>
            <th colspan="4" class="text-right">Shipping Cost</th>
            <th data-idx="vat"><?php echo number_to_currency($raw->ship_cost);?></th>
        </tr>
        <tr>
            <th colspan="4" class="text-right">Handling Cost / Other Cost</th>
            <th data-idx="vat"><?php echo number_to_currency($raw->other_cost);?></th>
        </tr>
        <tr>
            <th colspan="4" class="text-right">Grand Total</th>
            <th data-idx="vat"><?php echo number_to_currency($raw->grand_total);?></th>
        </tr>
    </tfoot>
</table>